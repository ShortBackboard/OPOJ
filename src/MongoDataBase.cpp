...
int64_t MoDB::GetMaxId(std::string name)
{
    ...
    mongocxx::collection coll = (*client)["OPOJ"][name.data()];
...
Json::Value MoDB::RegisterUser(Json::Value &registerjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection usercoll = (*client)["OPOJ"]["User"];
...
Json::Value MoDB::SelectProblemInfoByAdmin(Json::Value &queryjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection problemcoll = (*client)["OPOJ"]["Problem"];
...
Json::Value MoDB::InsertAnnouncement(Json::Value &insertjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection announcementcoll = (*client)["OPOJ"]["Announcement"];
        bsoncxx::builder::stream::document document{};
        document
            << "_id" << id
            << "Title" << title.data()
...
Json::Value MoDB::InsertDiscuss(Json::Value &insertjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection discusscoll = (*client)["OPOJ"]["Discuss"];
        bsoncxx::builder::stream::document document{};
        document
            << "_id" << id
            << "Title" << title.data()
...
Json::Value MoDB::InsertSolution(Json::Value &insertjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection solutioncoll = (*client)["OPOJ"]["Solution"];
        bsoncxx::builder::stream::document document{};
        document
            << "_id" << id
            << "Title" << title.data()
...
Json::Value MoDB::SelectCommentListByAdmin(Json::Value &queryjson)
{
    ...
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection commentcoll = (*client)["OPOJ"]["Comment"];
...
string MoDB::InsertStatusRecord(Json::Value &insertjson)
{
    try
    {
        ...
        auto client = pool.acquire();
        mongocxx::collection statusrecordcoll = (*client)["OPOJ"]["StatusRecord"];
        bsoncxx::builder::stream::document document{};
